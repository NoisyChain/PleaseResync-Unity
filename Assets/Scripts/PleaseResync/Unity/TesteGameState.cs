...
{
    public class TesteGameState : BaseGameState
    {
        ...
        public TesteGameState(uint frame, uint sum, uint playerCount)
        {
        ...
        public TesteGameState(BinaryReader br)
        {
            Deserialize(br);
        }
        ...
        {
            return obj is TesteGameState state &&
                    frame == state.frame &&
                    sum == state.sum;
        }
