    ...
    public class VectorWar : BaseGameState 
    {
        ...
        public override byte GetLocalInput(int PlayerID)
        {
            ...
            if (PlayerID == 0) {
                ...
                if (controls.Player1.ButtonA.WasPerformedThisFrame()) {
                    input |= INPUT_FIRE;
                }
                if (controls.Player1.ButtonB.WasPerformedThisFrame()) {
                    input |= INPUT_BOMB;
                }
            }
            else if (PlayerID == 1) {
                ...
                if (controls.Player2.ButtonA.WasPerformedThisFrame()) {
                    input |= INPUT_FIRE;
                }
                if (controls.Player2.ButtonB.WasPerformedThisFrame()) {
                    input |= INPUT_BOMB;
                }
            }
